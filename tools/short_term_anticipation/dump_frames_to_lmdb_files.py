...
import itertools
import json
from Ego4d_all.forecast.ego4d.datasets.short_term_anticipation import PyAVVideoReader, Ego4DHLMDB
from collections import defaultdict

parser = ArgumentParser()

parser.add_argument("--path_to_annotations", type=Path, default="/data/data3/rpasca/Datasets/Ego4d/data/annotations")
parser.add_argument("--path_to_videos", type=Path, default="/data/data3/rpasca/Datasets/Ego4d/data/full_scale")
parser.add_argument("--path_to_output_lmdbs", type=Path, default="/data/data3/rpasca/Datasets/Ego4d/data/lmdb")
parser.add_argument("--batch_size", type=int, default=1)
parser.add_argument("--context_frames", type=int, default=150)
...
dloader = DataLoader(dset, batch_size=args.batch_size, collate_fn=collate, num_workers=16)
